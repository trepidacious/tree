...
//  implicit def mirrorAndIdDeltaCodec[M](implicit mirrorDeltaCodec: Encoder[Delta[Mirror]], mDeltaCodec: Encoder[Delta[M]]): Encoder[Delta[MirrorAndId[M]]] = lensN(MirrorAndId.mirror)
