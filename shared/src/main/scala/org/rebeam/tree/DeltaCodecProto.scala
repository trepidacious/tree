...
//  sealed trait ListDelta[A] extends Delta[U, List[A]]
//
//  object ListDelta {
//
//    object ListIndexDelta {
//      implicit final def encoder[U, A: Encoder]: Encoder[ListIndexDelta[U, A]] = deriveEncoder
//      implicit final def decoder[U, A: Decoder]: Decoder[ListIndexDelta[U, A]] = deriveDecoder
//    }
//
//    case class ListIndexDelta[U, A](i: Int, a: A) extends ListDelta[U, A] {
